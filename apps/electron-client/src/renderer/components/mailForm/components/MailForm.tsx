...
const MailForm = forwardRef<HTMLInputElement, MailFormProps>(
  ({ sender, addSender, initialHtml, setHtml }, titleRef) => {
    return (
      <div className="flex flex-col w-full h-full rounded-lg bg-white p-2 font-pre-bold">
        {sender.length > 0 && <SenderList sender={sender} />}
